...
/**
 * @author weis
 * @Description:发送短信给全球各地的用户, 但是各大运营商的API都是 区分 国内 和 国际,
 * 但是我们只有电话号码, 只能自己添加一个方法, 判断号码的归属地, 然后再分别调用相应区域的API.
 * @date 2020/6/111:39
 */
public class PhoneUtils {
    ...
    public static JSONObject getPhoneNumberInfo(String phoneNumber) throws Exception {
        ...
        boolean checkSuccess = PhoneUtils.checkPhoneNumber(referencePhonenumber.getNationalNumber(), referencePhonenumber.getCountryCode());
        if (!checkSuccess) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(PhoneUtils.getPhoneNumberInfo("+85268476749").toJSONString());

        // {"number":"16467879865","regionCode":"US","nationalNumber":6467879865,"countryCode":1,"description":"美国","fullNumber":"+16467879865"}
        System.out.println(PhoneUtils.getPhoneNumberInfo("+16467879865").toJSONString());
